...
const css = `
  ...
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  .ai-title-grad {
    background:linear-gradient(90deg,#7BB3FF 0%,#4F8EF7 100%);
  ...
  .ai-dot:nth-child(3) { background:rgba(79,142,247,0.4); animation:dot-blink 2s 0.8s ease-in-out infinite; }
