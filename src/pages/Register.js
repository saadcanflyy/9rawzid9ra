...
const css = `
  ...
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  .success-icon { width:64px; height:64px; border-radius:16px; background:rgba(79,142,247,0.1); border:1px solid rgba(79,142,247,0.2); display:flex; align-items:center; justify-content:center; margin:0 auto 1.25rem; font-size:1.75rem; }
