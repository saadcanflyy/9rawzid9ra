...
const css = `
  ...
  .wm-logo-text b { color: #818CF8; font-weight: 500; }
  .wm-step-count {
  ...
  .wm-slide-desc {
    font-size: 0.84rem; color: #A4A0C8; text-align: center;
  ...
  .wm-feat {
    ...
    border: 1px solid rgba(44,42,66,0.5);
    border-radius: 8px;
    font-size: 0.78rem;
    color: #A4A0C8;
  }
  ...
  .wm-feat b { color: #EAE7FF; font-weight: 600; }
  ...
  .wm-dot {
    ...
    background: #2C2A42; transition: all 0.25s;
    border: none; padding: 0; cursor: pointer;
  }
  .wm-dot.on { background: #6366F1; width: 20px; border-radius: 3px; }
  .wm-dot.done { background: #6366F1; }
  ...
  .wm-back:hover { border-color: #3D3B5C; color: #EAE7FF; }
  .wm-cta {
    flex: 1;
  ...
  .wm-skip {
    ...
    font-size: 0.72rem; color: #666287; background: none; border: none;
    cursor: pointer; font-family: 'Outfit',sans-serif; width: 100%;
    transition: color 0.15s;
  }
  .wm-skip:hover { color: #A4A0C8; }

  .wm-uni-wrap { position: relative; margin-bottom: 1.25rem; }
  .wm-uni-input {
    width: 100%; background: #232232; border: 1px solid #2C2A42; border-radius: 10px;
    padding: 11px 14px; color: #EAE7FF; font-size: 0.875rem;
    font-family: 'Outfit',sans-serif; outline: none; transition: border-color 0.15s;
  }
  .wm-uni-input:focus { border-color: #6366F1; }
  .wm-uni-dd {
    position: absolute; top: calc(100% + 4px); left: 0; right: 0;
    background: #232232; border: 1px solid #2C2A42; border-radius: 10px;
    max-height: 180px; overflow-y: auto; z-index: 10;
    box-shadow: 0 8px 24px rgba(0,0,0,0.45);
  }
  .wm-uni-dd-item {
    padding: 9px 14px; cursor: pointer; font-size: 0.85rem; color: #EAE7FF;
    font-family: 'Outfit',sans-serif; border-bottom: 1px solid #2C2A42; transition: background 0.1s;
  }
  .wm-uni-dd-item:last-child { border-bottom: none; }
  .wm-uni-dd-item:hover { background: rgba(99,102,241,0.08); }
  .wm-uni-dd-empty { padding: 9px 14px; font-size: 0.75rem; color: #666287; font-family: 'DM Mono',monospace; }
...
const SLIDES = [
  {
    ...
    features: [
      { icon: '📚', bg: 'rgba(99,102,241,0.1)', text: '<b>Examens, CCs, TDs, TPs</b> — tout est là' },
      { icon: '🎓', bg: 'rgba(99,102,241,0.1)', text: '<b>55+ universités</b> et écoles couvertes' },
  ...
  },
  {
    ...
    features: [
      { icon: '🏫', bg: 'rgba(99,102,241,0.1)', text: 'Filtre par <b>université → faculté → filière</b>' },
      { icon: '📅', bg: 'rgba(99,102,241,0.1)', text: 'Choisis ton <b>semestre</b> (S1 à S10)' },
  ...
  },
  {
    ...
    features: [
      { icon: '⬆️', bg: 'rgba(99,102,241,0.1)', text: 'Upload un <b>PDF ou image</b> en 30 secondes' },
      { icon: '🏷️', bg: 'rgba(99,102,241,0.1)', text: 'Choisis le <b>module, semestre et type</b>' },
  ...
  },
  {
    ...
    features: [
      { icon: '❓', bg: 'rgba(99,102,241,0.1)', text: '<b>Pose une question</b> sur un module ou un prof' },
      { icon: '💡', bg: 'rgba(99,102,241,0.1)', text: '<b>Partage tes conseils</b> et astuces de révision' },
  ...
  },
  {
    ...
    features: [
      { icon: '📖', bg: 'rgba(99,102,241,0.1)', text: '<b>Explique-moi</b> ce chapitre en simple' },
      { icon: '📝', bg: 'rgba(99,102,241,0.1)', text: '<b>Résume</b> un cours ou un document' },
  ...
  },
  {
    ...
    features: [
      { icon: '📊', bg: 'rgba(99,102,241,0.1)', text: '<b>Mon profil</b> — tes stats, uploads et points' },
      { icon: '📌', bg: 'rgba(99,102,241,0.1)', text: '<b>Mes modules</b> — accès rapide aux modules sauvegardés' },
        ...
        <div className="wm-card" onClick={e => e.stopPropagation()}>
          ...
          {showUniStep ? (
            <div className="wm-slide" key="uni">
              <div className="wm-slide-icon" style={{ background:'rgba(99,102,241,0.1)' }}>🎓</div>
