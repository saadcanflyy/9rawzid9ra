...
const SLIDES = [
  {
    ...
    features: [
      ...
      { icon: '🎓', bg: 'rgba(45,212,191,0.1)', text: '<b>55+ universités</b> et écoles couvertes' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '📅', bg: 'rgba(45,212,191,0.1)', text: 'Choisis ton <b>semestre</b> (S1 à S10)' },
  ...
  },
  {
    ...
    features: [
      { icon: '⬆️', bg: 'rgba(45,212,191,0.1)', text: 'Upload un <b>PDF ou image</b> en 30 secondes' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '💡', bg: 'rgba(45,212,191,0.1)', text: '<b>Partage tes conseils</b> et astuces de révision' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '📝', bg: 'rgba(45,212,191,0.1)', text: '<b>Résume</b> un cours ou un document' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '📌', bg: 'rgba(45,212,191,0.1)', text: '<b>Mes modules</b> — accès rapide aux modules sauvegardés' },
